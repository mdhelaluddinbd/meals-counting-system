...
const MealCount = () => {
  return (
    <div className="container mb-5">
      ...
      <div className="  d-flex align-items-center justify-content-center  "  style={{width:"55rem"}}>
        <div
          class="row bg-info-subtle row-cols-1 row-cols-md-2 row-cols-lg-2 g-3 justify-content-evenly border  pt-0 pb-3 shadow rounded"
